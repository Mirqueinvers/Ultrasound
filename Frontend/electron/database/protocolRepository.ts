...
export class ProtocolRepository {
  ...
  savePrintOverrides(researchId: number, overrides: PrintBlockOverrides) {
    ...
    try {
      ...
      return { success: true, message: "Шаблоны протоколов успешно сохранены." };
    } catch (error) {
      console.error("Не удалось сохранить шаблоны протоколов", error);
      return { success: false, message: "Не удалось сохранить шаблоны протоколов." };
    }
  }
}
