...
export const ORG_LABELS: Record<SectionKey, string> = {
  ...
  "Слюнные железы:подъязычная правая": "Подъязычная: правая",
  "Слюнные железы:подъязычная левая": "Подъязычная: левая",
  ...
  "Лимфатические узлы:Поднижнечелюстные": "Л/узлы: Поднижнечелюстные",
  "Лимфатические узлы:Шейные": "Л/узлы: Шейные",
  "Лимфатические узлы:Подключичные": "Л/узлы: Подключичные",
  "Лимфатические узлы:Надключичные": "Л/узлы: Надключичные",
  "Лимфатические узлы:Подмышечные": "Л/узлы: Подмышечные",
  "Лимфатические узлы:Паховые": "Л/узлы: Паховые",
