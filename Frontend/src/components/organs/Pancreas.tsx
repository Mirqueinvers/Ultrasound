        ...
        <div>
          <label className={labelClasses}>
            ...
            >
              ...
              <option value="неоднородная">неоднородная</option>
              <option value="фиброзная">фиброзная</option>
            </select>
          </label>
        </div>
        ...
        <div>
          <label className={labelClasses}>
            ...
            >
              ...
              <option value="сдавлен">сдавлен</option>
            </select>
          </label>
        </div>
          ...
          <div>
            <label className={labelClasses}>
              ...
              <textarea
                ...
                placeholder="кисты, опухоли, кальцинаты, псевдокисты..."
      ...
      <fieldset className={fieldsetClasses}>
        ...
        <div>
          <textarea
            rows={3}
            className={inputClasses + " resize-y"}
            placeholder="дополнительные изменения, особенности исследования..."
      ...
      <fieldset className={fieldsetClasses}>
        ...
        <div>
          <textarea
            ...
            placeholder="панкреатит, диффузные изменения, опухоли, кисты..."
          />
        </div>
      </fieldset>
    </div>
