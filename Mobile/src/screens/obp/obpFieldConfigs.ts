...
export const LIVER_FIELDS: LiverFieldSpec[] = [
  { key: "rightLobeAP", label: "Правая доля, ПЗР", kind: "number", placeholder: "мм", visibilityGroup: "obp.liver.rightLobeAP" },
  { key: "leftLobeAP", label: "Левая доля, ПЗР", kind: "number", placeholder: "мм", visibilityGroup: "obp.liver.leftLobeAP" },
  { key: "rightLobeCCR", label: "Правая доля, ККР", kind: "number", placeholder: "мм", visibilityGroup: "obp.liver.rightLobeCCR" },
  { key: "rightLobeCVR", label: "Правая доля, КВР", kind: "number", placeholder: "мм", visibilityGroup: "obp.liver.rightLobeCVR" },
  { key: "leftLobeCCR", label: "Левая доля, ККР", kind: "number", placeholder: "мм", visibilityGroup: "obp.liver.leftLobeCCR" },
  { key: "rightLobeTotal", label: "Правая доля, ККР + ПЗР", kind: "number", placeholder: "Авторасчёт", visibilityGroup: "obp.liver.rightLobeTotal" },
  { key: "leftLobeTotal", label: "Левая доля, ККР + ПЗР", kind: "number", placeholder: "Авторасчёт", visibilityGroup: "obp.liver.leftLobeTotal" },
  { key: "echogenicity", label: "Эхогенность", kind: "select", options: ECHOGENICITY_OPTIONS, visibilityGroup: "obp.liver.echogenicity" },
  { key: "homogeneity", label: "Эхоструктура", kind: "select", options: HOMOGENEITY_OPTIONS, visibilityGroup: "obp.liver.homogeneity" },
  { key: "contours", label: "Контуры", kind: "select", options: CONTOURS_OPTIONS, visibilityGroup: "obp.liver.contours" },
  { key: "lowerEdgeAngle", label: "Угол нижнего края", kind: "select", options: LOWER_EDGE_OPTIONS, visibilityGroup: "obp.liver.lowerEdgeAngle" },
  { key: "focalLesionsPresence", label: "Патологические образования", kind: "select", options: FOCAL_OPTIONS, visibilityGroup: "obp.liver.focalLesionsPresence" },
  { key: "focalLesions", label: "Описание патологических образований", kind: "text", placeholder: "Введите описание", multiline: true, visibilityGroup: "obp.liver.focalLesions" },
  { key: "vascularPattern", label: "Сосудистый рисунок", kind: "select", options: VASCULAR_OPTIONS, visibilityGroup: "obp.liver.vascularPattern" },
  { key: "portalVeinDiameter", label: "Воротная вена", kind: "number", placeholder: "мм", visibilityGroup: "obp.liver.portalVeinDiameter" },
  { key: "ivc", label: "Нижняя полая вена", kind: "number", placeholder: "мм", visibilityGroup: "obp.liver.ivc" },
...
export const GALLBLADDER_FIELDS: GallbladderFieldSpec[] = [
  ...
  { key: "length", label: "Длина", kind: "number", placeholder: "мм", hiddenWhenCholecystectomy: true, visibilityGroup: "obp.gallbladder.length" },
  { key: "width", label: "Ширина", kind: "number", placeholder: "мм", hiddenWhenCholecystectomy: true, visibilityGroup: "obp.gallbladder.width" },
  { key: "wallThickness", label: "Толщина стенки", kind: "number", placeholder: "мм", hiddenWhenCholecystectomy: true, visibilityGroup: "obp.gallbladder.wallThickness" },
  ...
  { key: "constriction", label: "Перетяжка", kind: "select", options: GALLBLADDER_CONSTRICTION_OPTIONS, hiddenWhenCholecystectomy: true, visibilityGroup: "obp.gallbladder.constriction" },
  { key: "contentType", label: "Тип содержимого", kind: "select", options: GALLBLADDER_CONTENT_OPTIONS, hiddenWhenCholecystectomy: true, visibilityGroup: "obp.gallbladder.contentType" },
  { key: "concretions", label: "Конкременты", kind: "select", options: GALLBLADDER_YES_NO_OPTIONS, hiddenWhenCholecystectomy: true, visibilityGroup: "obp.gallbladder.concretions" },
  { key: "polyps", label: "Полипы", kind: "select", options: GALLBLADDER_YES_NO_OPTIONS, hiddenWhenCholecystectomy: true, visibilityGroup: "obp.gallbladder.polyps" },
  ...
  { key: "cysticDuct", label: "Пузырный проток", kind: "number", placeholder: "мм", hiddenWhenCholecystectomy: true, visibilityGroup: "obp.gallbladder.cysticDuct" },
  { key: "commonBileDuct", label: "Общий желчный проток", kind: "number", placeholder: "мм", hiddenWhenCholecystectomy: true, visibilityGroup: "obp.gallbladder.commonBileDuct" },
...
export const PANCREAS_FIELDS: PancreasFieldSpec[] = [
  { key: "head", label: "Головка", kind: "number", placeholder: "мм", visibilityGroup: "obp.pancreas.head" },
  { key: "body", label: "Тело", kind: "number", placeholder: "мм", visibilityGroup: "obp.pancreas.body" },
  { key: "tail", label: "Хвост", kind: "number", placeholder: "мм", visibilityGroup: "obp.pancreas.tail" },
  { key: "echogenicity", label: "Эхогенность", kind: "select", options: PANCREAS_ECHOGENICITY_OPTIONS, visibilityGroup: "obp.pancreas.echogenicity" },
  { key: "echostructure", label: "Эхоструктура", kind: "select", options: PANCREAS_ECHOSTRUCTURE_OPTIONS, visibilityGroup: "obp.pancreas.echostructure" },
  { key: "contour", label: "Контур", kind: "select", options: PANCREAS_CONTOUR_OPTIONS, visibilityGroup: "obp.pancreas.contour" },
  { key: "pathologicalFormations", label: "Патологические образования", kind: "select", options: YES_NO_OPTIONS, visibilityGroup: "obp.pancreas.pathologicalFormations" },
  { key: "pathologicalFormationsText", label: "Описание патологических образований", kind: "text", placeholder: "Введите описание", multiline: true, visibilityGroup: "obp.pancreas.pathologicalFormationsText" },
  { key: "wirsungDuct", label: "Вирсунгов проток", kind: "number", placeholder: "мм", visibilityGroup: "obp.pancreas.wirsungDuct" },
...
export const SPLEEN_FIELDS: SpleenFieldSpec[] = [
  { key: "position", label: "Положение", kind: "select", options: SPLEEN_POSITION_OPTIONS, visibilityGroup: "obp.spleen.position" },
  { key: "length", label: "Длина", kind: "number", placeholder: "мм", visibilityGroup: "obp.spleen.length" },
  { key: "width", label: "Ширина", kind: "number", placeholder: "мм", visibilityGroup: "obp.spleen.width" },
  { key: "echogenicity", label: "Эхогенность", kind: "select", options: SPLEEN_ECHOGENICITY_OPTIONS, visibilityGroup: "obp.spleen.echogenicity" },
  { key: "echostructure", label: "Эхоструктура", kind: "select", options: SPLEEN_ECHOSTRUCTURE_OPTIONS, visibilityGroup: "obp.spleen.echostructure" },
  { key: "contours", label: "Контур", kind: "select", options: SPLEEN_CONTOUR_OPTIONS, visibilityGroup: "obp.spleen.contours" },
  { key: "pathologicalFormations", label: "Патологические образования", kind: "select", options: YES_NO_OPTIONS, visibilityGroup: "obp.spleen.pathologicalFormations" },
  { key: "pathologicalFormationsText", label: "Описание патологических образований", kind: "text", placeholder: "Введите описание", multiline: true, visibilityGroup: "obp.spleen.pathologicalFormationsText" },
  { key: "splenicVein", label: "Селезёночная вена", kind: "number", placeholder: "мм", visibilityGroup: "obp.spleen.splenicVein" },
  { key: "splenicArtery", label: "Селезёночная артерия", kind: "number", placeholder: "мм", visibilityGroup: "obp.spleen.splenicArtery" },
...
export const OBP_FINAL_FIELDS: ObpFinalFieldSpec[] = [
  ...
  { key: "freeFluidDetails", label: "Описание свободной жидкости", kind: "text", placeholder: "Введите описание", multiline: true, visibilityGroup: "obp.final.freeFluidDetails" },
  ...
  { key: "recommendations", label: "Рекомендации", kind: "text", placeholder: "Введите рекомендации", multiline: true, visibilityGroup: "obp.final.recommendations" },
];
