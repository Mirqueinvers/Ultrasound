...
export const kidneyFields: KidneyFieldSpec[] = [
  ...
  { key: "length", label: "Длина", kind: "number", placeholder: "мм", visibilityGroup: "kidneys.length" },
  { key: "width", label: "Ширина", kind: "number", placeholder: "мм", visibilityGroup: "kidneys.width" },
  { key: "thickness", label: "Толщина", kind: "number", placeholder: "мм", visibilityGroup: "kidneys.thickness" },
  { key: "contour", label: "Контур почки", kind: "select", options: KIDNEY_CONTOUR_OPTIONS, visibilityGroup: "kidneys.contour" },
  { key: "parenchymaSize", label: "Размер паренхимы", kind: "number", placeholder: "мм", visibilityGroup: "kidneys.parenchymaSize" },
  { key: "parenchymaEchogenicity", label: "Эхогенность", kind: "select", options: KIDNEY_PARRENCHYMA_ECHOGENICITY_OPTIONS, visibilityGroup: "kidneys.parenchymaEchogenicity" },
  { key: "parenchymaStructure", label: "Структура", kind: "select", options: KIDNEY_PARRENCHYMA_STRUCTURE_OPTIONS, visibilityGroup: "kidneys.parenchymaStructure" },
  { key: "parenchymaConcrements", label: "Конкременты паренхимы", kind: "select", options: KIDNEY_YES_NO_OPTIONS, visibilityGroup: "kidneys.parenchymaConcrements" },
  { key: "parenchymaCysts", label: "Кисты паренхимы", kind: "select", options: KIDNEY_YES_NO_OPTIONS, visibilityGroup: "kidneys.parenchymaCysts" },
  { key: "parenchymaPathologicalFormations", label: "Патологические образования паренхимы", kind: "select", options: KIDNEY_YES_NO_OPTIONS, visibilityGroup: "kidneys.parenchymaPathologicalFormations" },
  {
    key: "pcsSize",
    label: "Размер ЧЛС",
    kind: "select",
    ...
    visibilityGroup: "kidneys.pcsSize",
  },
  { key: "pcsMicroliths", label: "Микролиты", kind: "select", options: KIDNEY_YES_NO_OPTIONS, visibilityGroup: "kidneys.pcsMicroliths" },
  { key: "pcsMicrolithsSize", label: "Размером до", kind: "number", placeholder: "мм", visibilityGroup: "kidneys.pcsMicrolithsSize" },
  { key: "pcsConcrements", label: "Конкременты ЧЛС", kind: "select", options: KIDNEY_YES_NO_OPTIONS, visibilityGroup: "kidneys.pcsConcrements" },
  { key: "pcsCysts", label: "Кисты ЧЛС", kind: "select", options: KIDNEY_YES_NO_OPTIONS, visibilityGroup: "kidneys.pcsCysts" },
  { key: "pcsPathologicalFormations", label: "Патологические образования ЧЛС", kind: "select", options: KIDNEY_YES_NO_OPTIONS, visibilityGroup: "kidneys.pcsPathologicalFormations" },
  ...
  { key: "adrenalArea", label: "Область надпочечников", kind: "select", options: KIDNEY_ADRENAL_OPTIONS, visibilityGroup: "kidneys.adrenalArea" },
