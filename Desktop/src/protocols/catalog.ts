...
export const SECTION_DEFINITIONS = [
  ...
  { id: 'obp.freeFluid', protocolId: 'obp', desktopKey: 'ОБП:свободная жидкость', label: 'Свободная жидкость', order: 5 },
...
export const PROTOCOL_DEFINITIONS = [
  {
    ...
    sectionIds: ['obp.liver', 'obp.gallbladder', 'obp.pancreas', 'obp.spleen', 'obp.freeFluid'],
  },
  {
    id: 'obp_v2',
    selectionLabel: 'ОБП (v2)',
    title: 'УЗИ органов брюшной полости (v2)',
    description: 'Печень, желчный пузырь, поджелудочная железа, селезёнка (динамическая форма из JSON).',
    sectionIds: ['obp.liver', 'obp.gallbladder', 'obp.pancreas', 'obp.spleen', 'obp.freeFluid'],
  },
  {
    id: 'kidneys',
