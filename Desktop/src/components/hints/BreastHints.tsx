...
const BreastHints: React.FC<BreastHintsProps> = ({ onAddText }) => {
  const samples: ConclusionSample[] = [
    ...
    },
    {
      ...
      value:
        "Эхографические признаки узловых изменений правой молочной железы.",
    },
    {
      title: "Узлов левой молочной железы",
      value:
        "Эхографические признаки узловых изменений левой молочной железы.",
    },
    {
      title: "Мастит",
  ...
  return (
    <div className="space-y-2">
      {samples.map((sample, index) => (
        <button
          key={index}
          onClick={() => onAddText(sample.value)}
