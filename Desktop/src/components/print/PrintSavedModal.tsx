    ...
    >
      <div className="bg-slate-100 rounded-xl w-[230mm] max-h-full flex flex-col overflow-hidden">
        <div className="flex items-center justify-between border-b border-slate-200 bg-slate-50 px-4 py-3">
          <div className="relative w-[260px]" ref={printerDropdownRef}>
            <button
              type="button"
            ...
            >
              <span className={`truncate ${selectedPrinter ? "text-slate-800" : "text-slate-400"}`}>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {!isEditing && (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-md bg-[#e0f2f7] px-4 py-2 text-sm font-medium text-[#0e7490] transition-all hover:bg-[#c8e6f0] disabled:cursor-not-allowed disabled:opacity-60 min-w-[140px] justify-center"
              >
